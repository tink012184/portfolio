...
export const routes: Routes = [
  ...
  { path: 'resume', component: ResumeComponent, title: 'Resume | Code By Lissa' },
  { path: 'projects', component: ProjectsComponent, title: 'Projects | Code By Lissa' },
  {
  ...
  { path: '**', component: NotFoundComponent, title: 'Page Not Found | Code By Lissa' }
];